...
test('a user can remove a tag from an item of a tag shortcut', function (): void {
...
test('a user can not remove a tag from an item of a tag shortcut of another user', function (): void {
    $user = User::factory()->create();
